...
box('worldBase',46,.10,78,0,-.18,-17,mats.stormGround);
...
CROSS_STREETS.forEach((z,i)=>{
  box('crossRoad'+i,38,.12,2.15,0,-.105,z,mats.road);
...
building(-8.7, 14,5.4,5.6,2,mats.wall1);
building( 8.7, 13,5.4,5.6,2,mats.wall2);
building(-8.7, -3,5.5,5.5,2,mats.wall3);
building( 8.7, -5,5.6,5.6,2,mats.wall1);

// Más edificios abiertos, todos con interior visible.
function decorBuilding(x,z,w,d,h,m){
  building(x,z,w,d,1.5,m,true);
}
[
  [-9.2,-17,5.0,5.2,1.5,mats.wall2],[ 9.2,-18,5.0,5.2,1.5,mats.wall3],
  [-9.0,-29,5.2,5.0,1.5,mats.wall1],[ 9.0,-30,5.1,5.0,1.5,mats.wall2],
  [-9.2,-41,5.0,5.0,1.5,mats.wall3],[ 9.2,-42,5.2,5.0,1.5,mats.wall1],
  [-15.3,7,5.1,5.0,1.5,mats.wall2],[15.3,5,5.1,5.0,1.5,mats.wall3],
  [-15.2,-12,5.0,5.2,1.5,mats.wall1],[15.2,-14,5.0,5.2,1.5,mats.wall2],
  [-15.1,-34,5.1,5.0,1.5,mats.wall3],[15.1,-36,5.1,5.0,1.5,mats.wall1]
...
async function loadCharacter(){
  try{
    ...
    setStatus(`INTERIORES + TINIEBLAS v18 · ${groundBoneMode} · ${boneNames}`);
