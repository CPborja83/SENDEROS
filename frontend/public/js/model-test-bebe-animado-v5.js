...
// Neutraliza desplazamiento propio de cadera/root
...
async function loadCharacter(){
  try{
    ...
    // Centrado y pies sobre el piso DESPUÉS de todos los giros.
    b=getBounds(meshes);
    ...
    ready=true;
    setStatus(`DE PIE v5 · ${groups.length} animaciones · controles L/R corregidos`);
