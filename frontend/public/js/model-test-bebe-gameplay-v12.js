...
function updateDarkness(){
  ...
  // Aun con atención alta, la tormenta impide ver toda la calle.
  scene.fogStart=2.2;
  scene.fogEnd=B.Scalar.Lerp(10.8,6.2,low)+temporaryFogBoost*-35;
...
async function loadCharacter(){
  try{
    ...
    setStatus(`CARTOON v12 · ${groundBoneMode} · ${boneNames}`);
